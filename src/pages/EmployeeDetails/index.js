    ...
    render() {
        ...
        return (
            ...
            <div style={{marginBottom:"30px"}}>
              <Container component="main" maxWidth="sm" style={{marginTop: "30px", marginBottom:"15%"}}>
                <Grid item component={Card} xs>
                    <CardContent>
                        <Table size="small" aria-label="a dense table">
                            <TableHead>
                                <TableRow>
                                    <StyledTableCell colSpan={2} align="center"><Typography variant="h6"
                                                                                            className={useStyles.title}
                                                                                            gutterBottom>Detalles del
                                        empleado</Typography></StyledTableCell>
                                </TableRow>
                            </TableHead>
                            <TableBody>
                                <StyledTableRow>
                ...
                <div align="center" style={{marginTop:"20px"}}>
                    <Button align="center " variant="contained" size='big' color="primary"
                            href={`#/bar/${idBarActual}/employees/update/${userActual}`}>Editar</Button>
                    ...
                    <Button align="center " variant="contained" size='big' color="primary"
                            href={`#/bar/${idBarActual}/employees`}>Volver</Button>
                </div>
              </Container>
              <Footer/>
            </div>
